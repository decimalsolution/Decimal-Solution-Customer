...
const HowCanWeHelpYou = ({ contactInfo }) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 w-[300px] flex flex-col">
      ...
      >
        <p className="bg-primary text-white font-medium text-sm py-2 px-4  shadow-lg z-[1000]">
          Hello!
      ...
      <button
        className="ml-auto border-2 border-primary text-primary bg-white font-medium text-sm py-2 px-4 rounded-md shadow-lg z-[1000]"
